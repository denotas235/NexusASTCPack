...
/**
 * Selects the Vulkan ASTC format and block size for a given texture identifier.
 *
 * VkFormat constants:
 *   ASTC 4x4 UNORM  = 157  SRGB = 158
 *   ASTC 6x6 UNORM  = 165  SRGB = 166
 *   ASTC 8x8 UNORM  = 171  SRGB = 172
 *   ASTC 4x4 SFLOAT = 1000066000  (VK_EXT_texture_compression_astc_hdr)
 */
public class ASTCFormatSelector {
    ...
    public static FormatInfo select(Identifier location) {
        String path = location.getPath(); // e.g. "textures/block/stone"

        // Normal maps — linear, fine detail -> 4x4 UNORM
        ...
        // GUI elements, font bitmaps, icons — 4x4 sRGB for sharpness
